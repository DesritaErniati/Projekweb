<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar"  style="background-color:purple;">
	...
	<!-- Sidebar - Brand -->
	<a class="sidebar-brand d-flex align-items-center justify-content-center" href="https://poltek-kampar.ac.id/">
		<div class="sidebar-brand-text mx-3">Poltek Kampar</div>
	</a>
